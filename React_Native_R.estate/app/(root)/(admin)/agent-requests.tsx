...
export default function AgentRequestsScreen() {
    ...
    <View className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 mb-3">
      <View className="flex-row items-center mb-3">
        ...
        <View className="flex-1 ml-3">
          ...
          <Text className="text-sm font-rubik text-gray-500">{item.email}</Text>
          <Text className="text-xs font-rubik text-gray-400">{item.phoneNumber}</Text>
        </View>
  ...
  const renderEmpty = () => (
    <View className="flex-1 items-center justify-center py-20">
      ...
      <Text className="text-gray-500 text-center px-8 font-rubik">
        {filter === "Pending"
  ...
  if (loading && !refreshing) {
    return (
      <SafeAreaView className="flex-1 bg-gray-50 items-center justify-center">
        ...
        <Text className="text-gray-500 mt-4 font-rubik">{t("common.loading")}</Text>
      </SafeAreaView>
    );
  }
        ...
        <View className="flex-1 bg-black/50 justify-center items-center px-6">
          <View className="bg-white rounded-2xl p-6 w-full max-w-md">
            ...
            <TextInput
              ...
              className="border border-gray-300 rounded-xl p-4 font-rubik text-black-300 min-h-[120px] mb-4"
            />
